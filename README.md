...
- The basic layout of the site was wireframed using Balsamiq. Whilst the mock-up's were created just for an overall view of the site on a laptop/desktop screen, the website was built completely on the grounds of responsiveness for all screen sizes.

#### Home Page Wireframe

![Home Page](Documentation/Wireframes/home-screen.png)

#### About Me Wireframe

![About Me](Documentation/Wireframes/about-me.png)

#### What I Teach Wireframe

![What I Teach](Documentation/Wireframes/what-i-teach.png)
...
![Contact Form](Documentation/Wireframes/contact-form.png)
...
- **Contact Form Section**
    ...
    - The form has a text are that allows the user to submit any additional details or to ask the questions that they may have.
